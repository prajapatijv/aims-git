...
Dim rsttemp As New ADODB.Recordset
    ...
    If Val(txtCode.Text) <= 0 Then
        rsttemp.Open xSource, AdoConnStr, adOpenStatic, adLockOptimistic
    Else
        SQL = " Select "
        ...
        rsttemp.Open SQL, AdoConnStr, adOpenDynamic, adLockOptimistic
    ...
    frmHlp.lblInfo.Caption = "Total Records : " & frmHlp.msfHelp.Rows - 1
...
Private Sub UserControl_Initialize()
    'AdoConnStr = "Provider=SQLOLEDB.1;Persist Security Info=False;User ID=sa;Initial Catalog=HInv05;Data Source=jvp"
End Sub
...
'Dim i As Integer
'
'    SQL = "Select top 1 * from " & m_TableName
'    With rsttemp
'        .Open SQL, AdoConnStr
'        If Not .EOF And Not .BOF Then
'            For i = 0 To .Fields.Count - 1
'                frmHlp.cmbSearch.AddItem .Fields.Item(i).Name
'            Next
'        End If
'    End With
'
